...
if(!index.includes("BUILD='040'"))throw new Error('index build missing');
...
if(!sw.includes("const CACHE='mguu-web-v040-vercel'"))throw new Error('wrong SW cache');
...
if(!app.includes('window.__mguuWebV040=true;'))throw new Error('v039 app marker missing');
if(!app.includes("const APP_VERSION='0.40 Web · Vercel';"))throw new Error('v039 UI version missing');
console.log('v0.40 PWA cache upgrade test: OK');
