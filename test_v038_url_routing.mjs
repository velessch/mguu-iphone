...
const start=app.indexOf("const APP_VERSION='0.38 Web · Vercel';");
...
if(!app.includes("const K_PORTAL_URL_MIGRATION_V038='mguu_v038_portal_urls_migrated';"))throw new Error('saved URL migration marker missing');
if(!app.includes('migrateRatingPortalUrlsV038();'))throw new Error('saved URL migration is not executed');
...
console.log('v0.38 Android-parity portal URL routing test: OK');
