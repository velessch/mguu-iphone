...
if(!index.includes("BUILD='038'"))throw new Error('index build missing');
...
if(!sw.includes("const CACHE='mguu-web-v038-vercel'"))throw new Error('wrong SW cache');
...
if(!app.includes('window.__mguuWebV038=true;'))throw new Error('v038 app marker missing');
if(!app.includes("const APP_VERSION='0.38 Web · Vercel';"))throw new Error('v038 UI version missing');
console.log('v0.38 PWA cache upgrade test: OK');
