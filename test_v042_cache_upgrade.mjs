...
if(!index.includes("BUILD='042'"))throw new Error('index build missing');
...
if(!sw.includes("const CACHE='mguu-web-v042-vercel'"))throw new Error('wrong SW cache');
...
if(!app.includes('window.__mguuWebV042=true;'))throw new Error('v042 app marker missing');
if(!app.includes("const APP_VERSION='0.42 Web · Vercel';"))throw new Error('v042 UI version missing');
console.log('v0.42 PWA cache upgrade test: OK');
