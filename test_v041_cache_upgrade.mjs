...
if(!index.includes("BUILD='041'"))throw new Error('index build missing');
...
if(!sw.includes("const CACHE='mguu-web-v041-vercel'"))throw new Error('wrong SW cache');
...
if(!app.includes('window.__mguuWebV041=true;'))throw new Error('v041 app marker missing');
if(!app.includes("const APP_VERSION='0.41 Web · Vercel';"))throw new Error('v041 UI version missing');
console.log('v0.41 PWA cache upgrade test: OK');
